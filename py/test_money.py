...
class TestMoney(unittest.TestCase):
    ...
    def testDivision(self):
        ...
        self.assertEqual(expected_money_after_division.amount,actual_money_after_division.amount)
        self.assertEqual(expected_money_after_division.currency,actual_money_after_division.currency)
    ...
    def testConversionWithDifferentRatesBetweemTwoCurrencies(self):
        ten_euros = Money(10, "EUR")
